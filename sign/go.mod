...
require (
	github.com/Flajt/decentproof-backend/encryption v0.0.0-20231221183440-472dd8430f97
	github.com/Flajt/decentproof-backend/helper v0.0.0-20231221183440-472dd8430f97
	github.com/Flajt/decentproof-backend/originstamp v0.0.0-20231221183440-472dd8430f97
